...
export const queryListResolveTemplate = `async (#{argsQuery}_root, args, context) =>#{error}
...
export const querySingleResolveTemplate = `async (query, _root, args, context) =>
    await #{prisma}.#{modelNameLower}.findUnique({
      where: args.where as Prisma.#{modelName}WhereUniqueInput,
      ...(query as { include?: Prisma.#{modelName}Include | undefined }),
    })`;

export const mutationCreateManyResolverTemplate = `async (_query, _root, args, context) =>
...
export const mutationCreateResolverTemplate = `async (query, _root, args, context) =>
...
export const mutationDeleteManyResolverTemplate = `async (_root, args, context) =>
...
export const mutationUpdateManyResolverTemplate = `async (_root, args, context) =>
    // @ts-expect-error // TODO fix this typing bug
...
export const mutationUpdateOneResolverTemplate = `async (query, _root, args, context) =>
...
export const mutationUpsertOneResolverTemplate = `async (query, _root, args, context) =>
